...
/**
 * Use case for recording a completed game
 */
class RecordGameUseCase @Inject constructor(
    private val statsRepository: StatsRepository
) {
    suspend operator fun invoke(result: GameResult, playerId: Int): Result<StatsData> {
        return statsRepository.recordGame(result, playerId)
    }
}
